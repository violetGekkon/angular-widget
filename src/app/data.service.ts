...
import {Page, PageRequest} from './modules/table/paginated-mat-table/paginated-data-source/intefaces/page.interface';
...
export class DataService {
  ...
  list(request: PageRequest<IncomingDocument>, query: DocumentsQuery): Observable<Page<IncomingDocument>> {
    const offset = request.page * request.size;
    return this.httpClient.get<any>(`${this.utmHost}/${this.outEndpoint}/list`, {
