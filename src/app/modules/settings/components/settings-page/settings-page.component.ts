...
import {SettingsItem, SettingsItemComponent} from '../settings-item/settings-item.component';
...
export class SettingsPageComponent implements OnInit, AfterViewInit {
  ...
  @ViewChildren('settingsContainer', {read: ElementRef}) settingsContainers: QueryList<ElementRef>;
  ...
  ngAfterViewInit() {
    this.settingsContainers.forEach(elem => console.log(elem.nativeElement.getBoundingClientRect().top));
  }
