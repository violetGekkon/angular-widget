...
import {Overlay, OverlayConfig, OverlayPositionBuilder, OverlayRef, PositionStrategy} from '@angular/cdk/overlay';
...
export class AppTooltipDirective implements OnInit {
  ...
  ngOnInit(): void {
    const config = new OverlayConfig({positionStrategy: this.positionStrategy});
